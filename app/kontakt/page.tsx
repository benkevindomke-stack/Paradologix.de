...
export default function ContactPage() {
  return <main className="contact-page">
    ...
    <header className="contact-head contact-wrap"><p><span /> PROJECT INQUIRY</p><h1>Was soll<br /><em>möglich werden?</em></h1><div><p>Erzähl uns von deiner Idee. Wir melden uns mit einem klaren nächsten Schritt zurück.</p><a href="mailto:studio@paradologix.com">studio@paradologix.com ↗</a></div></header>
    ...
    <footer className="contact-footer contact-wrap"><span>PARADOLOGIX</span><a href="mailto:studio@paradologix.com">studio@paradologix.com</a></footer>
  </main>;
}
