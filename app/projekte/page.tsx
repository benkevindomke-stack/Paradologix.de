...
export default function ProjectsPage() {
  return <main className="projects-page">
    <nav className="projects-nav projects-wrap"><a href="/" className="projects-logo">PARADOLOGIX<sup>®</sup></a><a href="/#services">Leistungen</a><a href="mailto:hello@paradologix.de">Projekt starten ↗</a></nav>
    ...
    <footer className="projects-footer projects-wrap"><p>HAST DU EIN PROJEKT IM KOPF?</p><a href="mailto:hello@paradologix.de">hello@paradologix.de <span>↗</span></a></footer>
  </main>;
}
