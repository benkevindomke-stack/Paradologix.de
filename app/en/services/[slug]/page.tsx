...
export default async function EnglishServicePage({ params }: { params: PageParams }) {
  ...
  return <main className={`service-page ${service.color}`}>
    ...
    <section className="service-cta service-wrap" id="contact"><p className="service-overline">MAKE SPACE FOR IT</p><h2>Tell us what<br /><em>could become real.</em></h2><a href="mailto:hello@paradologix.de">hello@paradologix.de <span>↗</span></a></section>
  </main>;
}
