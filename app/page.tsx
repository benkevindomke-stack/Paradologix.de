    ...
    <main>
      ...
      <section className="hero wrap" id="top">
        <div className="hero-copy">
          <p className="eyebrow"><span /> CREATIVE MEDIA STUDIO · BERLIN / EVERYWHERE</p>
        ...
        <div className="portal" aria-hidden="true">
          ...
          <div className="coordinates">52° 31′ N&nbsp;&nbsp; 13° 24′ E</div>
        </div>
      ...
      <footer className="footer wrap"><a className="wordmark" href="#top">PARADOLOGIX<span>®</span></a><p>© 2026 Paradologix</p><p>Berlin · Deutschland</p><a href="#top">Nach oben ↑</a></footer>
    </main>
  );
}
