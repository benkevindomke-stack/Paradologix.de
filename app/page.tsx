...
const work = [["01 / MEDIA SPACE", "Räume, die eine andere Wirklichkeit öffnen."], ["02 / WALL", "Wände als Verschiebung der Perspektive."], ["03 / MOTION", "Bewegung für Ideen mit eigener Schwerkraft."]];
const services = [["01", "Film & Motion", "Bewegte Bilder mit Haltung.", "/leistungen/videoproduktion"], ["02", "Media Spaces", "Digitale Ebenen für räumliche Erlebnisse.", "/leistungen/digital-signage-content"], ["03", "Wall Design", "Kunst, Material und Ort im Dialog.", "/leistungen/wandmalerei-wanddesign"], ["04", "Identity", "Identitäten mit unverwechselbarer Form.", "/leistungen/logo-design-agentur"]];
...
export default function Home() {
  return <main className="draft-home"><PortalMenu />
    ...
    <section className="draft-section draft-wrap" id="services"><div className="draft-section-head"><p className="draft-eyebrow">WAS WIR ENTWICKELN</p></div><h2>Form folgt<br /><em>Möglichkeit.</em></h2><div className="draft-services">{services.map(([number,name,copy,href])=><a className="draft-service" href={href} key={number}><span>{number}</span><h3>{name}</h3><p>{copy}</p><b>↗</b></a>)}</div></section>
